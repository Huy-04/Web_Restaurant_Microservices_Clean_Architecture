...
namespace Inventory.Domain.Entities
{
    public sealed class Ingredients : AggregateRoot
    {
        ...
        public static Ingredients Create(IngredientsName ingredientsName, Description description)
        {
            ...
            entity.AddDomainEvent(new IngredientsCreatedEvent(entity.Id, entity.IngredientsName.Value, entity.Description));
            return entity;
        }
        ...
        public void Update(IngredientsName ingredientsName, Description description)
        {
            ...
            Description = description;
            Touch();
            AddDomainEvent(new IngredientsUpdatedEvent(Id, IngredientsName.Value, Description.Value, UpdatedAt));
        }

        public void Delete()
        {
            Touch();
            AddDomainEvent(new IngredientsDeletedEvent(Id, UpdatedAt));
        }
